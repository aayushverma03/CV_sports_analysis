"""Smoke-run the 5 x 10 m Sprint with COD pipeline on a real video.

Usage: uv run scripts/smoke_5x10_cod.py [video_path]
"""
...
from src.tests.physical.sprint_5x10_cod import Sprint5x10CodTest  # noqa: E402
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_5x10_cod"
