"""Smoke-run the Illinois Agility pipeline on a real video.

Usage: uv run scripts/smoke_illinois_agility.py [video_path]
"""
...
from src.tests.physical.illinois_agility import IllinoisAgilityTest  # noqa: E402

DEFAULT_VIDEO = (
    ROOT / "data" / "01. Physical Capabilities" / "Illinois Agility Test"
    / "Illinois Agility Test.mp4"
)
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_illinois_agility"
