"""Smoke-run the T-Test pipeline on a real video.

Usage: uv run scripts/smoke_t_test.py [video_path]
"""
...
from src.tests.physical.t_test import TTestTest  # noqa: E402

DEFAULT_VIDEO = (
    ROOT / "data" / "01. Physical Capabilities" / "T-Test"
    / "videoplayback.1771961127148.publer.com.mp4"
)
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_t_test"
