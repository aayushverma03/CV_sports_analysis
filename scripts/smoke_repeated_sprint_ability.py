"""Smoke-run the Repeated Sprint Ability pipeline on a real video.

Usage: uv run scripts/smoke_repeated_sprint_ability.py [video_path]
"""
...
from src.tests.physical.repeated_sprint_ability import RepeatedSprintAbilityTest  # noqa: E402
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_repeated_sprint_ability"
