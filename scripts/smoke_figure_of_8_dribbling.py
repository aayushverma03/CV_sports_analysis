"""Smoke-run the Figure of 8 Dribbling pipeline on a real video.

Usage: uv run scripts/smoke_figure_of_8_dribbling.py [video_path]
"""
...
from src.tests.technical.figure_of_8_dribbling import FigureOf8DribblingTest  # noqa: E402
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_figure_of_8_dribbling"
