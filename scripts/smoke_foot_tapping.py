"""Smoke-run the Foot Tapping pipeline on a real video.

Usage: uv run scripts/smoke_foot_tapping.py [video_path]
"""
...
from src.tests.physical.foot_tapping import FootTappingTest  # noqa: E402

DEFAULT_VIDEO = (
    ROOT / "data" / "01. Physical Capabilities" / "Foot Tapping Test"
    / "Foot tapping test.mp4"
)
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_foot_tapping"
