"""Smoke-run the Zig-Zag Dribbling pipeline on a real video.

Usage: uv run scripts/smoke_zig_zag_dribbling.py [video_path]
"""
...
from src.tests.technical.zig_zag_dribbling import ZigZagDribblingTest  # noqa: E402

# User-preferred follow-camera recording.
DEFAULT_VIDEO = (
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_zig_zag_dribbling"
