"""Smoke-run the Standing Long Jump pipeline on a real video.

Usage: uv run scripts/smoke_standing_long_jump.py [video_path]
"""
...
from src.tests.physical.standing_long_jump import StandingLongJumpTest  # noqa: E402

DEFAULT_VIDEO = (
    ROOT / "data" / "01. Physical Capabilities" / "Standing Long Jump"
    / "videoplayback (2).mp4"
)
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_standing_long_jump"
