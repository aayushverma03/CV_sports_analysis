"""Smoke-run the Squat Jump pipeline on a real video.

Usage: uv run scripts/smoke_squat_jump.py [video_path]
"""
...
from src.tests.physical.squat_jump import SquatJumpTest  # noqa: E402

DEFAULT_VIDEO = (
    ROOT / "data" / "01. Physical Capabilities" / "Squat-Jump"
    / "videoplayback.1771961720746.publer.com.mp4"
)
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_squat_jump"
