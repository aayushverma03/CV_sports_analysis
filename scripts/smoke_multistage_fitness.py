"""Smoke-run the Multistage Fitness pipeline on a real video.

Usage: uv run scripts/smoke_multistage_fitness.py [video_path]
"""
...
from src.tests.physical.multistage_fitness import MultistageFitnessTest  # noqa: E402

DEFAULT_VIDEO = (
    ROOT / "data" / "01. Physical Capabilities"
    / "Multistage Fitness Test - Shuttle Run"
    / "videoplayback (5).mp4"
)
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_multistage_fitness"
