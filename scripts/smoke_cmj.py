"""Smoke-run the CMJ pipeline on a real video.

Usage: uv run scripts/smoke_cmj.py [video_path]
"""
...
from src.tests.physical.counter_movement_jump import CounterMovementJumpTest  # noqa: E402

DEFAULT_VIDEO = (
    ROOT / "data" / "01. Physical Capabilities" / "Counter-Movement-Jump" / "CMJ.mp4"
)
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_cmj"
