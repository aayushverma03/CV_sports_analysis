"""Smoke-run the Juggling pipeline on a real video.

Usage: uv run scripts/smoke_juggling.py [video_path]
"""
...
from src.tests.technical.juggling import JugglingTest  # noqa: E402

DEFAULT_VIDEO = (
    ROOT / "data" / "02. Technical Skills" / "Juggling Test" / "Juggling.mp4"
)
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_juggling"
