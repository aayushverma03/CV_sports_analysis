"""Smoke-run the Yo-Yo IR2 pipeline on a real video.

Usage: uv run scripts/smoke_yo_yo_intermittent.py [video_path]
"""
...
from src.tests.physical.yo_yo_intermittent import YoYoIntermittentTest  # noqa: E402

DEFAULT_VIDEO = (
    ROOT / "data" / "01. Physical Capabilities"
    / "Yo-Yo Intermittent Recovery Test"
    / "YO YO Intermittent test.mp4"
)
...
def main() -> int:
    ...
    out_dir = ROOT / "outputs" / "smoke_yo_yo_intermittent"
