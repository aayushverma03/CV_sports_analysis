...
| Agility | cone layout, COD detection, completion time, splits | T-Test · Illinois · Hurdle Agility |
...
| Endurance | distance covered, pacing, stage reached, audio-beep alignment | Yo-Yo · Multistage |
...
The CV pipeline covers seven families across 20 tests. Tests deferred from
v1 (awaiting data, or psychological/cognitive games shipping separately):
30-15 Intermittent, Cooper, DFB Agility, Incremental Ramp, Single-Leg Hop,
Sit-and-Reach, Stepwise Core Stability, DFB Shooting, LESS, Reaction Time,
Pattern Recognition, Video-Based Decision-Making.
